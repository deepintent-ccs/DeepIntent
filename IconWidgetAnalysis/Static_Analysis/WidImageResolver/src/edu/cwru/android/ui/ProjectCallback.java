...
/**
 * Simple implementation of {@link IProjectCallback}. This is a very basic
 * implementation that cannot support custom classes. Look for the one in ADT
 * for custom class support.
 *
 * Because there's no custom view support, the int to resource name is all
 * dynamic instad of looking up in the R.java class that was compiled.
 *
 */
public class ProjectCallback implements IProjectCallback {
	...
	public Object getAdapterItemValue(ResourceReference adapterView, Object adapterCookie, ResourceReference itemRef,
			int fullPosition, int positionPerType, int fullParentPosition, int parentPositionPerType,
